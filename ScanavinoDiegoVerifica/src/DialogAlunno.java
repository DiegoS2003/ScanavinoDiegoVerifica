...
public class DialogAlunno extends JDialog implements ActionListener{
	...
	public DialogAlunno(JFrame finestra, boolean modal, Elenco el ) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource().equals(aggiungi)) {
			el.add(new Alunno(insCognome.getText(),insNome.getText(), insCodiceFiscale.getText(),Integer.parseInt(insAnnoNascita.getText()), insClasse.getText()));
			this.dispose();
		}
	}
}
